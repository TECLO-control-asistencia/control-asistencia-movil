...
public class AsyncTaskGetListAsistanceFrList extends AsyncTask<Void, Void, AsistanceResponse> {
    private String TAG = AsyncTaskGetListAsistance.class.getSimpleName();
    public static boolean isRunning;
    AsyncTaskGetListAsistanceFrList.AsynckTasckResponseListAsistanceFrList listenerResponse;
    ...
    public AsyncTaskGetListAsistanceFrList(AsyncTaskGetListAsistanceFrList.AsynckTasckResponseListAsistanceFrList listenerResponse,
    ...
    protected void onPreExecute() {
        ...
        appSharePreferences.saveIsAsyncTaskListAsistanceRunningFrList(true);
    }
    ...
    protected void onPostExecute(AsistanceResponse result) {
        ...
        appSharePreferences.saveIsAsyncTaskListAsistanceRunningFrList(false);
        if(result == null){
    ...
    public interface AsynckTasckResponseListAsistanceFrList{
