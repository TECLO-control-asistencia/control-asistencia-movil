...
public class SSLSocketFactoryHelper extends SSLSocketFactory {
    ...
    public SSLSocketFactoryHelper(SSLSocketFactory delegate) {
    ...
    private class NoSSLv3SSLSocket extends DelegateSSLSocket {
        ...
        public void setEnabledProtocols(String[] protocols) {
            ...
            if(!enabledProtocols.contains("TLSv1.1")&&!enabledProtocols.contains("TLSv1.2")){
                Log.e("ssl error", "no TLSv1.1 or TLSv1.2 support on this Android OS, please update your OS");
            }
